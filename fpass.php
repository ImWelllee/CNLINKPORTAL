...
if(isset($_POST['btn-submit']))
{
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message= "
				   ...
				   <br /><br />
				   <a href='http://10.192.1.89/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
				   <br /><br />
				   thank you :)
				   ";
		$subject = "Password Reset for CNLink Customer Serivce Portal";
		...
		$msg = "<div class='alert alert-success'>
					...
					<br />
					Customer Service Portal - CNlink Networks Limited. 
			  	</div>";
